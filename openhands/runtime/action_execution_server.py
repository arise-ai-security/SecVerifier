...
class ActionExecutor:
    ...
    async def read(self, action: FileReadAction) -> Observation:
        ...
        try:
            if filepath.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif')):
                with open(filepath, 'rb') as file:  # noqa: ASYNC230
            ...
            with open(filepath, 'r', encoding='utf-8') as file:  # noqa: ASYNC230
    ...
    async def write(self, action: FileWriteAction) -> Observation:
        ...
        try:
            with open(filepath, mode, encoding='utf-8') as file:  # noqa: ASYNC230
                if mode != 'w':
    ...
    async def upload_file(
        ...
        try:
            ...
            if recursive or file.filename.endswith('.zip'):
                ...
                with open(zip_path, 'wb') as buffer:  # noqa: ASYNC230
