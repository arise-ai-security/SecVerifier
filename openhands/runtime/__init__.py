...
# Try to import KubernetesRuntime - it has optional dependencies
try:
    ...
    # kubernetes package not installed, KubernetesRuntime will not be available
    pass
...
# Add KubernetesRuntime if it's available
if 'kubernetes' in _DEFAULT_RUNTIME_CLASSES:
